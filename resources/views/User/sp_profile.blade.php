        ...
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <div class="d-flex justify-content-center mb-2">
              <button id="btn_1" type="button" class="btn btn-primary" onclick="{{$relations['fun_name_1']}}" >{{$relations['relation_1']}}</button>
              <button id="btn_2" type="button" class="btn btn-outline-primary ms-1" onclick="{{$relations['fun_name_2']}}">{{$relations['relation_2']}}</button>
            </div>
          </div>
        </div>
                            ...
                            <div class="card">
                                <div class="d-flex justify-content-between p-2 px-3">
                                    <div class="d-flex flex-row align-items-center"> <img src="" width="50" class="rounded-circle">
                                        <div class="d-flex flex-column ml-2"> <span class="font-weight-bold">{{ $post['post_writer_name'] }}</span> <small class="text-primary">Collegues</small> </div>
                                    </div>
                                ...
                                <div class="p-2">
                                    ...
                                    @foreach($post['comments'] as $comment)
                                        <div class="d-flex flex-row mb-2"> <img src="" width="40" class="rounded-image">
                                            <div class="d-flex flex-column ml-2"> <span class="name">{{$comment['comment_owner']}}</span> <small class="comment-text">{{$comment['comment']}}</small>
